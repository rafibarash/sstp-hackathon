...
func HandleNotification(w http.ResponseWriter, r *http.Request) {
	...
	stmt := spanner.NewStatement("SELECT i.Tag, i.Digest FROM Images i JOIN Dependencies d ON d.SourceDigest = SPLIT(i.Digest, \"@\")[OFFSET(1)] WHERE d.BaseRef = @baseRef AND d.BaseDigest != @baseDigest")
